...
export default function LoanPaymentPage() {
    ...
    const [paymentAmount, setPaymentAmount] = useState<Omit<CurrencyValues, 'cny'>>({...initialCurrencyValues});
    ...
    const handleAmountChange = (currency: keyof Omit<CurrencyValues, 'cny'>, value: string) => {
